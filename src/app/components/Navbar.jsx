  ...
  return (
    <nav className="fixed mx-auto border border-[#33353F] top-0 left-0 right-0 z-10 bg-[#121212] bg-opacity-100">
      <div className="flex container lg:py-4 flex-wrap items-center justify-between mx-auto px-4 py-2">
        ...
        >
          <span className="text-[#ff9ff3]">S</span>ajib{" "}
          <span className="text-[#ff9ff3]">H</span>ossen
        </Link>
        ...
        <div className="menu hidden md:block md:w-auto" id="navbar">
          <ul className="flex justify-center items-center p-4 md:p-0 md:flex-row md:space-x-8 mt-0">
            ...
            {user ? (
              <li>
                {" "}
                <button className="text-white border px-4 py-2 rounded-md border-white hover:bg-[#ff9ff3] hover:text-black transition">
                  Logout
                </button>
              </li>
            ) : (
